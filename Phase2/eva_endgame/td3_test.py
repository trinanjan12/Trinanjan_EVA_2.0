...
class Train_TD3():
    ...
    def __init__(self):
        ...
        exp_name = 'NA'
        self.file_name = '/home/trinanjan/Desktop/EVA/EVA_TEST/Session_10_ENDGAME/ENDGAME_TEST_CODE/pytorch_models/TD3_First_model_new_test2_10/TD3_First_model_new_test2_10_59'
        self.policy.load(self.file_name)

    def test(self,reward,new_signal):
        # print('loading model from',self.file_name )
        new_state = new_signal[0]
